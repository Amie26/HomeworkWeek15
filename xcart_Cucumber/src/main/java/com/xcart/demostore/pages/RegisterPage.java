...
WebElement _verifyMessage;
    ...
    public void clickOnCreateNewAccountLink() {
        ...
        log.info("Clicks on create new account link" + _createNewAccountLink.toString());
    ...
    public void sendTextToPasswordField(String regPwd) {
        ...
        log.info("Sends password to the Field" + _passwordField.toString());
    ...
    public void sendTextToConfirmPasswordField(String confPwd) {
        ...
        log.info("Sends password to confirm password field" + _confirmPasswordField.toString());
    ...
    public void clickOnCreateButton() {
        Reporter.log(" clicks on Create Button " + _createBtn.toString() + "<br>");
        log.info("Clicks on Create button" + _createBtn.toString());
        clickOnElement(_createBtn);
    }

    //This method verifies use is on My account Page
